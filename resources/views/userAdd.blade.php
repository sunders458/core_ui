        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-dark">Créer un nouveau compte</li>
                    <!--end::Item-->
                </ul>
                <!--end::Breadcrumb-->
            </div>
                ...
                <div class="col-xl-12">
                    ...
                    <div class="card card-flush h-lg-100" id="kt_contacts_main">
                        ...
                        <div class="card-body pt-5">
                            ...
                            {!! Form::open(array('id'=>'kt_ecommerce_settings_general_form', 'class'=>'form', 'route' => 'users.store','method'=>'POST')) !!}
                                ...
                                <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <label class="fs-6 fw-bold form-label mt-3">
                                                <span class="required">Nom & Prénoms (Raison sociale)</span>
                                                <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip" title="Enter the contact's name."></i>
                                            </label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            
                                            {!! Form::text('name', null, array('class' => 'form-control form-control-solid')) !!}
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            {!! Form::text('firstname', null, array('class' => 'form-control form-control-solid')) !!}
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                    </div>
                                ...
                                <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Select2-->
                                            <select data-control="select2" class="form-select form-select-solid lh-1 py-3" name="country" data-kt-ecommerce-settings-type="select2_flags" data-placeholder="Select a country">
                                                        <option></option>
                                                        ...
                                                        <option value="CI" data-kt-select2-country="assets/media/flags/ivory-coast.svg" selected>Côte d'Ivoire</option>
                                ...
                                <div class="row row-cols-1 row-cols-sm-2 rol-cols-md-1 row-cols-lg-2">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="fv-row mb-7">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-bold form-label mt-3">
                                                <span class="required">Eglise</span>
                                            </label>
                                            <!--end::Label-->
                                            <div class="w-100">
                                                <div class="form-floating border rounded">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    {!! Form::select('roles[]', $roles,[], array('class' => 'form-select form-select-solid','multiple')) !!}
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                                <!--begin::Separator-->
