      ...
      <div>
        ...
        <div class="card mt-3">
                    ...
                    <td class="whitespace-nowrap px-4 py-3 sm:px-5">
                        @if(!empty($user->getRoleNames()))
                            @foreach($user->getRoleNames() as $v)
                                <div
                                    class="badge badge-success rounded-full"
                                >
                                    {{ $v }}
                                </div>
                            @endforeach
                            ...
                            <ul>
                              ...
                              <li>
                                ...
                                {!! Form::open(['method' => 'DELETE','route' => ['users.destroy', $user->id],'style'=>'display:inline']) !!}
                                    {!! Form::submit('Supprimer', ['class' => 'btn h-8 w-24 p-0 text-error hover:bg-error/20 focus:bg-error/20 active:bg-error/25']) !!}
                                {!! Form::close() !!}
                              </li>
                            </ul>
          ...
          >
            ...
            <div class="text-xs+">1 - 10 of 10 Enregistrements</div>
          </div>
        </div>
      </div>
