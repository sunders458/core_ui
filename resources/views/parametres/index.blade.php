   ...
   <div class="grid grid-cols-12 gap-4 sm:gap-5 lg:gap-6">
      <div class="col-span-12 lg:col-span-4">
        ...
        <div class="col-span-12 lg:col-span-8">
            <div class="card">
                <form action="{{ isset($societe) ? route('societes.update', $societe->id) : route('societes.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @if(isset($societe))
                        @method('PUT')
                    @endif
                <div class="flex flex-col items-center space-y-4 border-b border-slate-200 p-4 dark:border-navy-500 sm:flex-row sm:justify-between sm:space-y-0 sm:px-5">
                    ...
                    <div class="flex justify-center space-x-2">
                        <button type="button" onclick="window.location='{{ route('societes.index') }}'"
                        ...
                        <button type="submit"
                           ...
                           {{ isset($societe) ? 'Modifier' : 'Ajouter' }}
                        </button>
                    </div>
                </div>
                <div class="p-4 sm:p-5">
                    <div class="flex flex-col">
                        ...
                        <div class="avatar mt-1.5 size-20">
                            <img class="mask is-squircle" src="{{ isset($societe->logo) ? asset('storage/' . $societe->logo) : 'images/avatar/avatar-20.jpg' }}" alt="avatar" />
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <label class="block">
                            ...
                            <span class="relative mt-1.5 flex">
                                <input name="nom" value="{{ old('nom', isset($societe) ? $societe->nom : '') }}" class="form-input peer w-full rounded-full border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                        ...
                        <label class="block">
                            <span>Email</span>
                            <span class="relative mt-1.5 flex">
                                <input name="email" value="{{ old('email', isset($societe) ? $societe->email : '') }}" class="form-input peer w-full rounded-full border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                        ...
                        <label class="block">
                            <span>Téléphone</span>
                            <span class="relative mt-1.5 flex">
                                <input name="telephone" value="{{ old('telephone', isset($societe) ? $societe->telephone : '') }}" class="form-input peer w-full rounded-full border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                        ...
                        <label class="block">
                            <span>Site Web</span>
                            <span class="relative mt-1.5 flex">
                                <input name="site_web" value="{{ old('site_web', isset($societe) ? $societe->site_web : '') }}" class="form-input peer w-full rounded-full border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                        ...
                        <label class="block">
                            ...
                            <span class="relative mt-1.5 flex">
                                <input name="numero_siret" value="{{ old('numero_siret', isset($societe) ? $societe->numero_siret : '') }}" class="form-input peer w-full rounded-full border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                    placeholder="Enter SIRET number" type="text" />
                            </span>
                        </label>
                        <label class="block">
                            <span>Numéro TVA</span>
                            <span class="relative mt-1.5 flex">
                                <input name="numero_tva" value="{{ old('numero_tva', isset($societe) ? $societe->numero_tva : '') }}" class="form-input peer w-full rounded-full border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                    placeholder="Enter VAT number" type="text" />
                            </span>
                        </label>
                        <label class="block">
                            <span>Statut Juridique</span>
                            <span class="relative mt-1.5 flex">
                                <input name="statut_juridique" value="{{ old('statut_juridique', isset($societe) ? $societe->statut_juridique : '') }}" class="form-input peer w-full rounded-full border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                    placeholder="Enter legal status" type="text" />
                            </span>
                        </label>
                        <label class="block">
                            <span>Année de Création</span>
                            <span class="relative mt-1.5 flex">
                                <input name="annee_creation" value="{{ old('annee_creation', isset($societe) ? $societe->annee_creation : '') }}" class="form-input peer w-full rounded-full border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                    placeholder="Enter creation year" type="number" />
                            </span>
                        </label>
                        <label class="block">
                            <span>Dirigeant</span>
                            <span class="relative mt-1.5 flex">
                                <input name="dirigeant" value="{{ old('dirigeant', isset($societe) ? $societe->dirigeant : '') }}" class="form-input peer w-full rounded-full border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                    placeholder="Enter leader" type="text" />
                            </span>
                        </label>
                        <label class="block">
                            <span>Logo</span>
                            <input name="logo" type="file" class="form-input w-full rounded-full border border-slate-300 bg-transparent px-3 py-2 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent" />
                            @if(isset($societe) && $societe->logo)
                                <img src="{{ asset('storage/' . $societe->logo) }}" alt="Logo" class="mt-2 w-32 h-32 object-cover">
                            @endif
                        </label>
                    </div>
                    <div class="my-7 h-px bg-slate-200 dark:bg-navy-500"></div>
