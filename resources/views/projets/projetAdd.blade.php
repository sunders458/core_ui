        ...
        <div class="card space-y-5 p-4 sm:p-5">
          <label class="block">
            ...
            <select
              ...
              placeholder="Sélectionnez l'employer..."
            ></select>
          </label>
          <label class="block">
            <span class="font-medium text-slate-600 dark:text-navy-100"
            ...
            >
              ...
              <option value="digital">Immobilier</option>
              <option value="technology">Foncier</option>
              {{-- <option value="home">Home</option> --}}
              <option value="accessories">Amenagement</option>
            </select>
          </label>
          <label class="block">
            <span class="font-medium text-slate-600 dark:text-navy-100"
