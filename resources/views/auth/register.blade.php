        ...
        <form class="form w-100"   method="POST" action="{{ route('register') }}">
            @csrf
                ...
                <div class="mb-10 text-center">
                    ...
                    <a href="/login" class="link-primary fw-bolder">Se connecter ici</a></div>
                    <!--end::Link-->
                </div>
                <!--end::Heading-->
                <!--begin::Action
                ...
                <div class="row">
                    <div class="col-md-5">
                        <label class="form-label fw-bolder text-dark fs-6">Pays</label><span style="color:red">*</span><br><br>
                        
                        <!--end::Hint-->
                        <select data-control="select2" class="form-control form-control-lg form-control-solid" type="tel"  name="pays_id" autocomplete="phone">
                            @php 
                                use Illuminate\Support\Facades\DB;
                                $pays = DB::table('pays')->get();
                                foreach($pays as $pay){
                                    echo "<option value='$pay->idPays'>";
                                    echo $pay->libelle;
                                    echo "</option>";
                                }             
                            @endphp
                ...
                <div class="mb-10 fv-row" data-kt-password-meter="true">
                    ...
                    <div class="mb-1">
                        <!--begin::Label-->
                        <label class="form-label fw-bolder text-dark fs-6">Mot de passe</label><span style="color:red">*</span>
                        <!--end::Label-->
                        <!--begin::Input wrapper-->
                ...
                <div class="fv-row mb-5">
                    <label class="form-label fw-bolder text-dark fs-6">Confirmez le mot de passe</label> <span style="color:red">*</span>
