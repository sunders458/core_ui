            ...
            <div class="card card-flush mt-6 mt-xl-9">
                ...
                <div class="card-header mt-5">
                    ...
                    <div class="card-title flex-column">
                        ...
                        <h2> {{number_format($soutienstotal, 0, ',', ' ')}} F CFA</h2>
                        </div>
                    </div>
                    <!--begin::Card title-->
                    <!--begin::Card toolbar-->
                    <div class="card-toolbar my-1">
                        <!--begin::Select-->
                        <div class="me-4 my-1">
                        <a href="{{route('soutien.add')}}" class="btn btn-primary btn-sm">Ajouter</a>
                        </div>
                        <!--end::Select-->
                        <!--begin::Search-->
                    ...
                    <div class="table-responsive">
                        ...
                        <table id="kt_profile_overview_table" class="table table-row-bordered table-row-dashed gy-4 align-middle fw-bolder">
                            ...
                            <thead class="fs-7 text-gray-400">
                                <tr>
                                    <th class="min-w-250px">Partenaires</th>
                                    <th class="min-w-150px">Projets</th>
                                    <th class="min-w-150px">Contacts</th>
                            ...
                            <tbody class="fs-6">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="d-flex flex-column justify-content-center">
                                                <a href="" class="fs-6 text-gray-800 text-hover-primary">{{$item->name}}
                                        </a>
                                                {{--
                                    ...
                                    <td class="text-end">
                                        <a href="{{route('soutiens.confirm',$item->id)}}" class="btn btn-primary btn-sm">Validez</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
