                ...
                <div class="mt-3 grid grid-cols-2 gap-3 px-3">
                  <div class="rounded-lg bg-slate-100 p-2.5 dark:bg-navy-600">
                    <div class="flex items-center space-x-2">
                      <img
                        class="h-10 w-10"
                        src="{{asset('assets/images/logos/bitcoin.svg')}}"
                        alt="image"
                      />
                      <div>
                        <h2
                  ...
                  <div class="rounded-lg bg-slate-100 p-2.5 dark:bg-navy-600">
                    <div class="flex items-center space-x-2">
                      <img
                        class="h-10 w-10"
                        src="{{asset('assets/images/logos/solana.svg')}}"
                        alt="image"
                      />
                      <div>
                        <h2
            ...
            >
              ...
              >
                <div class="flex items-center space-x-3">
                  <img
                    ...
                    src="{{asset('assets/images/illustrations/lms-ui.svg')}}"
                    alt="image"
                  />
                  <div>
                    <p
              ...
              >
                <div class="flex items-center space-x-3">
                  <img
                    class="h-10 w-10 rounded-lg object-cover object-center"
                    src="{{asset('assets/images/illustrations/store-ui.svg')}}"
                    alt="image"
                  />
                  <div>
                    <p
                ...
                <div class="mt-3 flex items-center justify-between space-x-2">
                  <div class="flex -space-x-3">
                    <div class="avatar h-7 w-7 hover:z-10">
                      <img
                        class="rounded-full ring ring-white dark:ring-navy-700"
                        src="{{asset('assets/images/avatar/avatar-17.jpg')}}"
                        alt="avatar"
                      />
                    </div>
                    <div class="avatar h-7 w-7 hover:z-10">
              ...
              >
                <div class="flex items-center space-x-3">
                  <img
                    class="h-10 w-10 rounded-lg object-cover object-center"
                    src="{{asset('assets/images/illustrations/chat-ui.svg')}}"
                    alt="image"
                  />
                  <div>
                    <p
              ...
              >
                <div class="flex items-center space-x-3">
                  <img
                    class="h-10 w-10 rounded-lg object-cover object-center"
                    src="{{asset('assets/images/illustrations/nft.svg')}}"
                    alt="image"
                  />
                  <div>
                    <p
                ...
                <li class="timeline-item">
                  ...
                  <div class="timeline-item-content flex-1 pl-4">
                    ...
                    <div class="mt-4 grid grid-cols-3 gap-3">
                      ...
                      <img
                        class="rounded-lg"
                        src="{{asset('assets/images/object/object-3.jpg')}}"
                        alt="image"
                      />
                      <img
                        class="rounded-lg"
                        src="{{asset('assets/images/object/object-4.jpg')}}"
                        alt="image"
                      />
                      <img
                        class="rounded-lg"
                      ...
                      <img
                        class="rounded-lg"
                        src="{{asset('assets/images/object/object-6.jpg')}}"
                        alt="image"
                      />
                    </div>
                    <div class="mt-4">
