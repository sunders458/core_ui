...
<head>
	...
	<meta name="description" content="The most advanced Bootstrap Admin Theme on Themeforest trusted by 94,000 beginners and professionals. Multi-demo, Dark Mode, RTL support and complete React, Angular, Vue &amp; Laravel versions. Grab your copy now and get life-time updates for free." />
      ...
      <link rel="icon" type="image/png" sizes="16x16" href="{{asset('assets/img/favicon_io/favicon-16x16.png')}}">
		...
		<link href="{{asset('metro/assets/plugins/custom/datatables/datatables.bundle.css')}}" rel="stylesheet" type="text/css" />
		<link href="{{asset('metro/assets/plugins/custom/vis-timeline/vis-timeline.bundle.css')}}" rel="stylesheet" type="text/css" />
...
<script src="{{asset('metro/assets/js/custom/widgets.js')}}"></script>
<script src="{{asset('metro/assets/js/custom/apps/chat/chat.js')}}"></script>
<script src="{{asset('metro/assets/js/custom/utilities/modals/upgrade-plan.js')}}"></script>
<script src="{{asset('metro/assets/js/custom/utilities/modals/new-target.js')}}"></script>
<script src="{{asset('metro/assets/js/custom/utilities/modals/create-project/type.js')}}"></script>
<script src="{{asset('metro/assets/js/custom/utilities/modals/create-project/budget.js')}}"></script>
<script src="{{asset('metro/assets/js/custom/utilities/modals/create-project/settings.js')}}"></script>
<script src="{{asset('metro/assets/js/custom/utilities/modals/create-project/team.js')}}"></script>
<script src="{{asset('metro/assets/js/custom/utilities/modals/create-project/targets.js')}}"></script>
<script src="{{asset('metro/assets/js/custom/utilities/modals/create-project/files.js')}}"></script>
<script src="{{asset('metro/assets/js/custom/utilities/modals/create-project/complete.js')}}"></script>
<script src="{{asset('metro/assets/js/custom/utilities/modals/create-project/main.js')}}"></script>
<script src="{{asset('metro/assets/js/custom/utilities/modals/create-app.js')}}"></script>
<script src="{{asset('metro/assets/js/custom/utilities/modals/new-address.js')}}"></script>
<script src="{{asset('metro/assets/js/custom/utilities/modals/users-search.js')}}"></script>
