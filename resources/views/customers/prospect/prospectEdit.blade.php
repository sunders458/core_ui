...
<main class="main-content w-full px-[var(--margin-x)] pb-8">
  {!! Form::model($prospect, ['route' => ['prospects.update', $prospect->id], 'method' => 'patch', 'files' => true]) !!}
    <div
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  <label class="block">
                    ...
                    <span class="relative mt-1.5 flex">
                      ...
                      {!! Form::text('name',null,['placeholder'=>'Entrez le nom','class'=>'form-input peer w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent']) !!}
                      <span
              ...
              <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                ...
                <label class="block">
                  ...
                  <span class="relative mt-1.5 flex">
                    ...
                    {{-- {!! Form::select('pays_id', $countries, $bycountries ?? null ,array('class' => 'w-full','autocomplete'=>'off','placeholder'=>'Pays de résidence...', 'x-init'=>'$el._tom = new Tom($el)')) !!} --}}
